...
export default function Home() {
  ...
  return (
    <div className="flex flex-col pt-3 min-h-screen">
...
const FormInput = ({ children, value, onchange, name }) => {
  return (
    <>
      ...
      <input
        className="rounded-sm w-10 text-center focus:outline-none text-gray-600 focus:ring-0 focus:border-transparent"
        value={value}
        onChange={onchange}
        type="number"
        name={name}
